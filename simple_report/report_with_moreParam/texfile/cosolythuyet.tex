\chapter{Tương tác của photon với vật chất}%*\label{line:simplereport_cosolythuyet_chapter}*) 
\label{ch:cosolythuyet}%*\label{line:simplereport_cosolythuyet_label}*) 
...
\begin{figure}[!h]%*\label{line:simplereport_cosolythuyet_figBegin}*)
\centering
...
\label{fig:klein}
\end{figure}%*\label{line:simplereport_cosolythuyet_figEnd}*)
